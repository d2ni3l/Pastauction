...
export default function AddVehiclePhoto() {
  ...
  return (
    <div className=' mx-4'>
      <h2 className='font-semibold text-lg pb-6'>Service book certificate</h2>
      <div className='flex flex-col gap-16 '>
        <div className='grid grid-row-2 sm:grid-cols-6 grid-cols-3 gap-5 grid-flow-row'>
          ...
          {img6 ? (
            ...
            <label
              htmlFor='servicebookimage6'
              className='bg-white shadow-sm rounded-lg hover:scale-[.95] cursor-pointer transition-all duration-500 flex justify-center items-center gap-2  py-16 px-12'>
              <input
                type='file'
                id='servicebookimage6'
          ...
          {addPhotos && (
            <>
              {img10 ? (
                ...
                <label
                  htmlFor='servicebookimage10'
                  className='bg-white shadow-sm rounded-lg hover:scale-[.95] cursor-pointer transition-all duration-500 flex justify-center items-center gap-2  py-16 px-12'>
                  <input
                    type='file'
                    id='servicebookimage10'
              ...
              {img7 ? (
                ...
                <label
                  htmlFor='servicebookimage7'
                  className='bg-white shadow-sm rounded-lg hover:scale-[.95] cursor-pointer transition-all duration-500 flex justify-center items-center gap-2  py-16 px-12'>
                  <input
                    type='file'
                    id='servicebookimage7'
              ...
              {img8 ? (
                ...
                <label
                  htmlFor='servicebookimage8'
                  className='bg-white shadow-sm rounded-lg hover:scale-[.95] cursor-pointer transition-all duration-500 flex justify-center items-center gap-2  py-16 px-12'>
                  <input
                    type='file'
                    id='servicebookimage8'
              ...
              {img9 ? (
                ...
                <label
                  htmlFor='servicebookimage9'
                  className='bg-white shadow-sm rounded-lg hover:scale-[.95] cursor-pointer transition-all duration-500 flex justify-center items-center gap-2  py-16 px-12'>
                  <input
                    type='file'
                    id='servicebookimage9'

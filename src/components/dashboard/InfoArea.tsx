    ...
    <div>
      ...
      <div className='relative w-full  h-full flex justify-center items-center overflow-y-scroll scroll-hidden'>
        <div className='relative max-w-sm  sm:max-w-4xl md:w-[600px] mt-[500px] lg:mt-[50px]  bg-white rounded-lg shadow px-10 py-5'>
          ...
          <div className="flex justify-center"><h3 className="text-lg font-semibold">Info area</h3></div>
         ...
         <div className="rounded-sm border flex-col flex sm:flex-row sm:justify-start justify-center border-gray-400 sm:p-2 p-4 px-4  gap-5">
            <Image src='/images/infoareaimage.svg' alt='image' width='150' height='150' className='  w-full sm:w-auto'/>

            <div className="flex flex-col gap-2 ">
                <h5 className='font-semibold text-center'>Delete image</h5>
                <p className="text-sm text-gray-500 text-center tracking-wide">Are you sure you want to delete your photo? This action cannot be undone. Are you sure you want to delete your photo? This action cannot be undone. Are you sure you want to delete your photo? This action cannot be undone. Are you sure you want to delete your photo? This action </p>
            </div>

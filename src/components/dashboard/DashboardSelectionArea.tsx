...
<div
      ...
      <div className='relative w-full  h-full flex justify-center items-center'>
        <div className='relative max-w-sm  sm:max-w-2xl pb-16 bg-white rounded-lg shadow p-10'>
          ...
          <div className="flex justify-center gap-6 pt-5">
            ...
            <div onClick={() => {setModal(false)}} className="flex flex-col items-center hover:scale-[.95] duration-300 transition-all cursor-pointer  rounded-lg border-[1.5px] shadow-sm border-gray-500 py-4 px-11">
                ...
                <p className="text-center text-sm text-gray-600 pt-1">Select if you want to manage your Garage, Charts area, Find parts and much more</p>
            </div>
            ...
            <div onClick={() => {setModal(false)}}  className="flex flex-col items-center hover:scale-[.95] duration-300 transition-all cursor-pointer  rounded-lg border-[1.5px] shadow-sm border-gray-500 py-4 px-11">
                ...
                <p className="text-center text-sm text-gray-600 pt-1">Select if you want to manage Events, Services, Opening time, user and much more</p>
            </div>
          </div>

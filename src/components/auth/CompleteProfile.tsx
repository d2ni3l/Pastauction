...
// i wanna take currentUser an obj and merge with form new input and send to api
  ...
  const onSubmit = (data: Input) => {
    Object.assign(data, {image: filebase64} );
    ...
    <div className='w-full'>
      {
        deleteImageModal && (
          ...
          <DeleteImageModal setDeleteImageModal={setDeleteImageModal} setFileBase64={setFileBase64} />
        )
      }
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-2'>
              <div className='flex justify-center items-center '>
               ...
               <input type="file" name="" onChange={(e)=> convertFile(e.target.files)} className='hidden' id="file" />
                  </>
                )
               }
               {
                filebase64 && (
                  <div className='relative'>
                     ...
                     width='25'
                     height='25'
                     onClick={() => {setDeleteImageModal(prev => prev = true)}}
              ...
              <div className='flex flex-col gap-3'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Input className='placeholder:text-xs placeholder:text-gray-600 h-9 '  placeholder='Mr/Mrs' {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Input className='placeholder:text-xs placeholder:text-gray-600 h-9'  placeholder='First name' {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Input className='placeholder:text-xs placeholder:text-gray-600 h-9' placeholder='Surname' {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Input className='placeholder:text-xs placeholder:text-gray-600 h-9'  onFocus={(e) => (e.target.type = "date")} 
                         placeholder='Date'  {...field} type='text'  />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                render={({ field }) => (
                  <FormItem className='space-y-0'>
                    <FormLabel className='py-0 my-0 text-xs text-gray-600'>Country</FormLabel>
                    <Select
              ...
              />
                ...
                render={({ field }) => (
                  <FormItem className='space-y-0'>
                    <FormLabel className='py-0 my-0 text-xs text-gray-600'>City</FormLabel>
                    <Select
              ...
              <div className='flex justify-center items-center'>
                <Button className='px-32 mt-3' variant='blackWide' type='submit'>
                  Complete
                </Button>
              </div>
            </form>
...
const DeleteImageModal = ({setFileBase64,setDeleteImageModal }: DeleteImageModal) => {
  return(
        ...
        <div className='relative max-w-sm  sm:max-w-sm bg-white rounded-lg shadow p-10'>
          ...
          <div className='flex flex-col items-center justify-center'>
            ...
            <div className='pt-8 flex gap-3'>
              ...
              <Button  onClick={() => {setFileBase64(''); setDeleteImageModal(false)}}  variant='blackWide' className='px-10'>
